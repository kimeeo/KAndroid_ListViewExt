...
public class SwipeDeck extends FrameLayout {
    ...
    public SwipeDeck(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                ...
                0, 0);
        try {
            NUMBER_OF_CARDS = a.getInt(R.styleable.SwipeDeck_swipe_deck_max_visible, 3);
            ROTATION_DEGREES = a.getFloat(R.styleable.SwipeDeck_swipe_deck_rotation_degrees, 15f);
            CARD_SPACING = a.getDimension(R.styleable.SwipeDeck_swipe_deck_card_spacing, 15f);
            RENDER_ABOVE = a.getBoolean(R.styleable.SwipeDeck_swipe_deck_render_above, true);
            RENDER_BELOW = a.getBoolean(R.styleable.SwipeDeck_swipe_deck_render_below, false);
            CARD_GRAVITY = a.getInt(R.styleable.SwipeDeck_swipe_deck_card_gravity, 0);
            OPACITY_END = a.getFloat(R.styleable.SwipeDeck_swipe_deck_opacity_end, 0.33f);
        } finally {
            a.recycle();
        }
